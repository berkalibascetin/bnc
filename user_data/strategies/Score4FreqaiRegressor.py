...
"""
Classic FreqAI regressor (official example style) on Score4Window-like features.

Predicts mean future return over label_period_candles.
...
class Score4FreqaiRegressor(IStrategy):
    INTERFACE_VERSION = 3
    can_short = False
